...
FounderPostAI_AISuite_SEO_Optimizer::mark_current( 7 );

if ( ! FounderPostAI_AISuite_SEO_Optimizer::is_current( 7 ) ) {
...
FounderPostAI_AISuite_SEO_Optimizer::mark_current( 7 );
$request_hash         = FounderPostAI_AISuite_SEO_Optimizer::analysis_hash( 7 );
$posts[7]->post_title = 'Edited while the analysis job was running';
FounderPostAI_AISuite_SEO_Optimizer::mark_current( 7, $request_hash );
